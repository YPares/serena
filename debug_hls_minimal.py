#!/usr/bin/env python3
"""
Minimal HLS debug to see what's happening
"""
import json

# Create a simple debug test that runs with the same environment as the test
test_code = '''
import os, sys, time
...
with open("/home/ypares/dev/serena/run_hls_debug.py", "w") as f:
    f.write(test_code)

print("Debug script created at run_hls_debug.py")